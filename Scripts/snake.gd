...
func _input(event):
	if (event.is_action_pressed("right") && move_direction.x == 0):
		move_direction = Vector2.RIGHT
	elif (event.is_action_pressed("left") && move_direction.x == 0):
		move_direction = Vector2.LEFT
	elif (event.is_action_pressed("up") && move_direction.y == 0):
		move_direction = Vector2.UP
	elif (event.is_action_pressed("down") && move_direction.y == 0):
